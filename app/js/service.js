...
.factory("Level", ["$q", function($q){
	...
	factory.get = function (level) {
		switch(level) {
			...
			return {
				q: "אני מוסגל..",
				a: ["לעסוק בעבודות הדורשות פעילות פיזית", "להבין נוסחאות מדעיות", "לעסוק בתחומים הדורשים רמה יצירתיות גבוהה", "לבטא חום כלפי אחרים", "לקחת סיכונים בתחום הכלכלי", "להתמודד עם שיגרה וסדר יום קבוע"]
			}
			break;
			case 6:
			return {
